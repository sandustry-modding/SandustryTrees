...
The oak shoot grows a shorter trunk (about **48** cells) that is thicker than pine.
Wood forks into crown branches.
Leaves sit in tufts on the limb tips, not as one solid disk.
...
| `tree/oak/oakShoot/`    | Oak trunk height, growth, sapling   |
