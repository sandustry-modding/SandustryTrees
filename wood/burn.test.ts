...
import { pickSpreadNeighbor } from "./burn.ts";

test("pickSpreadNeighbor returns null when no wood neighbors", () => {
...
test("pickSpreadNeighbor uses the roll to pick among candidates", () => {
  const wood = new Set(["5,4", "6,5", "5,6", "4,5"]);
