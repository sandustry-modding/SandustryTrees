import { burnRawWood, ignitePrimedRawWood } from "../burn/charcoal.ts";
import { growPineShoot } from "../grow/growth.ts";
import { collapseIfUnsupported, collapseTrunkFromDestroyed } from "../harvest/worker.ts";
import { breakPineNeedle, compostLeafDust } from "../needles/needles.ts";
import {
