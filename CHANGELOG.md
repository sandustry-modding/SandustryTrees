...
- Changed: grab pine needles with the grabber to turn them into Leaf Dust.
- Changed: the needle canopy fills empty cells only. It does not replace terrain or other elements.
- Changed: pine cones plant when they touch **Water**. The water is consumed. Trees stay attached to Dirt.
