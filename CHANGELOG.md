...
- Changed: pine and oak trunks start 1 cell wide.
  They thicken toward their mature width as they grow.
...
- Changed: the upper oak trunk splits into two crown leaders.
  There are no low side limbs.
- Changed: oak crown leaders are two cells wide.
- Changed: oak leaves overlap into a dense crown.
  The crotch between the two leaders is filled.
- Added: **Oak** trees.
